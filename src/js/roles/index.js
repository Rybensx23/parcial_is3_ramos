...
const buscar = async () => {
    ...
    const url = `/parcial_is3_ramos/API/roles/buscar?rol_nombre=${rol_nombre}`;
    const config = {
        method : 'GET'
    }
...
const guardar = async (evento) => {
    ...
    body.delete('rol_id')
    const url = '/parcial_is3_ramos/API/roles/guardar';
...
const modificar = async () => {
    ...
    const body = new FormData(formulario)
    const url = '/parcial_is3_ramos/API/roles/modificar';
    const config = {
        method : 'POST',
        body
    }
...
const eliminar = async (e) => {
    ...
    if(await confirmacion('warning','¿Desea eliminar este registro?')){
        ...
        body.append('rol_id', id)
        const url = '/parcial_is3_ramos/API/roles/eliminar';
        const headers = new Headers();
        headers.append("X-Requested-With","fetch");
        const config = {
            method : 'POST',
